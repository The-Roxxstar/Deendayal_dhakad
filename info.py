...
DEENDAYAL_VERIFIED_LOG = int(environ.get('DEENDAYAL_VERIFIED_LOG', '-1002203125942')) #Log channel id ( make sure bot is admin )
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+nG_g6v-Snho0ZGJl')
